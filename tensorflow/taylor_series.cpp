...
REGISTER_KERNEL_BUILDER(Name("TaylorSeriesNCS").Device(DEVICE_CPU), TaylorSeriesOp<Eigen::ThreadPoolDevice,true>);
REGISTER_KERNEL_BUILDER(Name("TaylorSeriesNSC").Device(DEVICE_CPU), TaylorSeriesOp<Eigen::ThreadPoolDevice,false>);
REGISTER_KERNEL_BUILDER(Name("TaylorSeriesGradNCS").Device(DEVICE_CPU), TaylorSeriesGradOp<Eigen::ThreadPoolDevice,true>);
REGISTER_KERNEL_BUILDER(Name("TaylorSeriesGradNSC").Device(DEVICE_CPU), TaylorSeriesGradOp<Eigen::ThreadPoolDevice,false>);

// Register the GPU kernels.
#ifdef GOOGLE_CUDA 
REGISTER_KERNEL_BUILDER(Name("TaylorSeriesNCS").Device(DEVICE_GPU), TaylorSeriesOp<Eigen::GpuDevice,true>);
REGISTER_KERNEL_BUILDER(Name("TaylorSeriesNSC").Device(DEVICE_GPU), TaylorSeriesOp<Eigen::GpuDevice,false>);
REGISTER_KERNEL_BUILDER(Name("TaylorSeriesGradNCS").Device(DEVICE_GPU), TaylorSeriesGradOp<Eigen::GpuDevice,true>);
REGISTER_KERNEL_BUILDER(Name("TaylorSeriesGradNSC").Device(DEVICE_GPU), TaylorSeriesGradOp<Eigen::GpuDevice,false>);
#endif  // GOOGLE_CUDA
