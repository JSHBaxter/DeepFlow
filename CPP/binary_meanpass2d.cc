...
class BinaryMeanpass2dOp : public OpKernel {
public:
    explicit BinaryMeanpass2dOp(OpKernelConstruction* context) : OpKernel(context) {}
    ...
    void Compute(OpKernelContext* context) override {
        ...
        int num_intermediates_full = BinaryMeanpass2dFunctor<Device>().num_buffers_full();
        int num_intermediates_images = BinaryMeanpass2dFunctor<Device>().num_buffers_images();
...
// template parameter <float> is the datatype of the tensors.
template <typename Device>
class BinaryMeanpass2dGradOp : public OpKernel {
public:
    explicit BinaryMeanpass2dGradOp(OpKernelConstruction* context) : OpKernel(context) {}
    ...
    void Compute(OpKernelContext* context) override {
        ...
        int n_s = size_array[1]*size_array[2]*size_array[3];
        int n_i = size_array[2]*size_array[3];
        int num_intermediates_full = BinaryMeanpass2dGradFunctor<Device>().num_buffers_full();
        int num_intermediates_images = BinaryMeanpass2dGradFunctor<Device>().num_buffers_images();
        float** buffers_full = NULL;
        float** buffers_imgs = NULL;
        get_temporary_buffers(context, buffers_full, n_s, num_intermediates_full, buffers_imgs, n_i, num_intermediates_images, data_cost);
