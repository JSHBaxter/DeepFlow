...
class BinaryAuglag2dOp : public OpKernel {
public:
    explicit BinaryAuglag2dOp(OpKernelConstruction* context) : OpKernel(context) {}
    ...
    void Compute(OpKernelContext* context) override {
        ...
        int num_intermediates_full = BinaryAuglag2dFunctor<Device>().num_buffers_full();
        int num_intermediates_images = BinaryAuglag2dFunctor<Device>().num_buffers_images();
