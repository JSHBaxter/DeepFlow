        ...
        for i in range(1):
            ...
            for devicename in ['GPU', 'CPU']:
                ...
                with tf.Session(config=config) as sess:
                    ...
                    flow = meanpass_module.potts_meanpass3d(data,rx,ry,rz)
