...
class BinaryAuglag3dOp : public OpKernel {
public:
    explicit BinaryAuglag3dOp(OpKernelConstruction* context) : OpKernel(context) {}
    ...
    void Compute(OpKernelContext* context) override {
        ...
        int num_intermediates_full = BinaryAuglag3dFunctor<Device>().num_buffers_full();
        int num_intermediates_images = BinaryAuglag3dFunctor<Device>().num_buffers_images();
