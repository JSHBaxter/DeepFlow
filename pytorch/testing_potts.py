...
def test_dimensionality(d):
    ...
    data_r = (1*np.clip(0.25*np.random.normal(0,1,size=size_info)+np.array([i % 2 for i in range(x**d)]).reshape(size_red_info),0,100)).astype(np.float32)
    ...
    if d == 1:
        oa_1 = torch.exp(Potts_MAP1d.apply(t,r))
        om_1 = Potts_Mean1d.apply(t,r)
    elif d == 2:
        oa_1 = torch.exp(Potts_MAP2d.apply(t,r,r))
        om_1 = Potts_Mean2d.apply(t,r,r)
    elif d == 3:
        oa_1 = torch.exp(Potts_MAP3d.apply(t,r,r,r))
        om_1 = Potts_Mean3d.apply(t,r,r,r)
    ...
    if d == 1:
        oa_2 = torch.exp(Potts_MAP1d.apply(t,r))
        om_2 = Potts_Mean1d.apply(t,r)
    elif d == 2:
        oa_2 = torch.exp(Potts_MAP2d.apply(t,r,r))
        om_2 = Potts_Mean2d.apply(t,r,r)
    elif d == 3:
        oa_2 = torch.exp(Potts_MAP3d.apply(t,r,r,r))
        om_2 = Potts_Mean3d.apply(t,r,r,r)
